...
- [Bug] Arreglar el error de transito de datos, al dejar en blanco el proveedor o categoría de un producto, este bug es causado por el select. En todo caso hay que agregar una validación por JS
Error:
